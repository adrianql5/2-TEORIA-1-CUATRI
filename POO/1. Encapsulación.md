...
- **Acceso a paquete:** pueden acceder métodos de las clases que pertenezcan al **mismo paquete** (carpeta).

- **Acceso protegido:** pueden acceder métodos de todas las clases que pertenezcan al **mismo paquete** y también **subclases** de la clase (aunque no estén en el mismo paquete)..
