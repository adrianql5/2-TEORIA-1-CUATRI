...
> [!Nota]
> **No sucede aliasing con los wrappers ni los tipos de datos primitivos** (se explicará más adelante lo que es el aliasing)
...
- **Objetos creados a lo largo de la ejecución del programa**
- **Strings** (*tanto las del string pool como las que se crean con new*)
- **Gestión de la basura-> recolector**
