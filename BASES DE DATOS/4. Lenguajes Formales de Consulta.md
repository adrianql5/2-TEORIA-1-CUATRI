...
- **Orden de atributos**: Primero los atributos comunes, luego los únicos de la primera relación y, finalmente, los únicos de la segunda relación.
...
Aquí tienes el texto reescrito utilizando el formato estándar de LaTeX, colocando las fórmulas entre `$$`:
