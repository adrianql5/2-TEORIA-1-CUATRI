...
- En general, se utilizan **letras griegas** para los **conjuntos de atributos**, **latinas minúsculas** seguidas de una **mayúscula entre paréntesis** para un **esquema de relación**, cuando se usar una **griega minúscula** se refiera a un **conjunto de atributos**, que puede ser o no un esquema, cuando se una la **latina**, indica que es un **esquema**. UNa **superclave** se indica con *K*, se usa un **nombre en minúsculas** para las **relaciones** y el término **ejemplar** se refiere a una **valor concreto** en un momento dado. 
